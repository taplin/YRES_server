...
public class YRESRealm: Realm {
    private var accountStore: YRESAccountStore
    private var random: Random = URandom()
    
    /// Initializer for YRESRealm
    init(accountStore: YRESAccountStore) {
    ...
    */
    ...
    public func register(credentials: Credentials) throws -> Account {
        var newAccount = YRESAccount(id: String(random.secureToken))
 ...
 */
        ...
        accountStore.persistAccount(newAccount)
